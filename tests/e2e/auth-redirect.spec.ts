...
test('User visits song page, logs in manually, and stays on song page', async ({ page }) => {
...
test('User visits different song page, logs in manually, and stays on that song page', async ({ page }) => {
