    ...
    <Paper sx={{
        ...
        <Box>
            <Box sx={{
                ...
                <Typography variant='subtitle2' fontWeight={200}>Nalezeno v <strong>{props.originalFile.name}</strong></Typography>
                ...
                }}>{editable?"Uložit":"Upravit"}</Button>
            </Box>
        </Box>
        <Box sx={{
        ...
        <Box sx={{
            ...
            <StyledInput placeholder='Název písně' value={title} onChange={(e)=>{
                setTitle(e.target.value);
            }}/>
            <StyledInput placeholder='Obsah písně' value={sheetData} multiline onChange={(e)=>{
