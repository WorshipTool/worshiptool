...
export default function LeftGroupPanel() {
  ...
  return (
    <>
        <Box bgcolor={"#414141"} minWidth={300} top={0} zIndex={10} bottom={0} display={"flex"} flexDirection={"column"}>
            ...
            <Box padding={1} flex={1} display={"flex"} flexDirection={"column"} justifyContent={"end"}>
                {isOn ? <>
                    <Button color='secondary' variant='contained' onClick={openActivePlaylist}>Otevřít aktivní playlist</Button>
                    <Gap/>
                </>:<></>}
