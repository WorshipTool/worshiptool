...
export const useApiStateEffect = <T,>(dispatch: () => Promise<T>, deps?: DependencyList, ...props: UseApiStateProps<T> ) : [ApiState<T>, () => void] => {
    const {fetchApiState, apiState, invalidateApiState} = useApiState<T>(...props);
