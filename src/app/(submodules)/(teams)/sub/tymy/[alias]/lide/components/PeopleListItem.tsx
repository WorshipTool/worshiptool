...
import ActionsPartPeople from '@/app/(submodules)/(teams)/sub/tymy/[alias]/lide/components/ActionsPartPeople'
import RolePart from '@/app/(submodules)/(teams)/sub/tymy/[alias]/lide/components/RolePart'
