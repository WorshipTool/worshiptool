import ListTopPanelPeople from '@/app/(submodules)/(teams)/sub/tymy/[alias]/lide/components/ListTopPanelPeople'
import PeopleListItem from '@/app/(submodules)/(teams)/sub/tymy/[alias]/lide/components/PeopleListItem'
